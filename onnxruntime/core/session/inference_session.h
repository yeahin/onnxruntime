...
class InferenceSession {
 ...
 private:
  ...
  struct CachedExecutionProviderForGraphReplay {
    ...
    Status ReplayGraph(int graph_annotation_id, bool sync_stream) {
      if (cached_execution_provider_for_graph_replay_) {
        return cached_execution_provider_for_graph_replay_->ReplayGraph(graph_annotation_id, sync_stream);
      }
